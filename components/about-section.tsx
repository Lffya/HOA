export default function AboutSection() {
  return (
    <section id="about" className="py-24 bg-white dark:bg-hoa-charcoal transition-colors duration-400">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-2 gap-16 text-left">
            <div>
              <h3 className="text-2xl font-bold text-hoa-charcoal dark:text-white mb-6 font-serif">Our Story</h3>
            ...
            <div>
              <h3 className="text-2xl font-bold text-hoa-charcoal dark:text-white mb-6 font-serif">Vision & Mission</h3>
